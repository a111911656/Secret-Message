    ...
    <body>
        ...
        <header>
            ...
            <div class="jumbotron text-center bg-secondary jumbotron-inside">
                <h5 class="text-white">Read and Edit Message</h5>
            </div>
        </header>

        <div class="container">
            <form action="proses-edit.php" method="POST">
            <input type="hidden" class="form-control" name="id" value="<?php echo $pesan['id'] ?>">
                <br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="subject" value="<?php echo $pesan['subject'] ?>" placeholder="Subject Message" required>
                    </div>
                </div><br>
                <div class="form-group row">
                    <label for="cipherori" class="col-sm-2 col-form-label">Origial Ciphertext</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" id="cipherori" rows="3" readonly><?php echo $pesan['text'] ?></textarea>
                    </div>
                </div><br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="button" value="Encrypt" class="btn btn-info" id="enkripsi">
                    </div>
                </div><br>
                <div class="form-group row">
                    <label for="cipher" class="col-sm-2 col-form-label">Changed Ciphertext</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="cipher" id="cipher" rows="3" readonly></textarea>
                    </div>
                </div><br>
                <button type="submit" class="btn btn-warning" name="simpan">Edit Message</button><br><br>
            </form>
        </div>
...
<script type="text/javascript">
    ...
    dekripsi.onclick = function(){
        var cipher = document.getElementById('cipherori').value;
